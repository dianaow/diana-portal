...
(function() {
  ...
  jQuery(document).on('init:users_select', function() {
    return $('.users_select').select2({
      width: '100%',
      ...
      formatResult: function(user) {
        return '<div class=\'select2-user-result\'> <span>' + user.name + '</span><p>' + user.email + ' ' + '</p></div>';
      }
    });
  });

  jQuery(document).on('change', 'select.topESelect', function() {
    $.ajax({
...
$(document).ready(function () {
  $(".btn-tag-cat").click(function(e){
    var id = event.target.id;
    alert(id);
    id.append("<span class='glyphicon glyphicon-remove'></span>");
    }, function(){
    id.remove("<span class='glyphicon glyphicon-remove'</span>");
  });
});
/*!
 * Select2 4.0.3
...
(function() {
  ...
  jQuery(document).on('submit', '.browse-form-button', function() {
    return $('#nav-search').find('input#q_title_cont').val('');
  });
...
(function() {
  App.conversation = App.cable.subscriptions.create('ConversationChannel', {
    ...
    received: function(data) {
      var chat_area, conversation, height, list, member_list;
      chat_area = $('.chat_area');
    ...
    speak: function(personal_message) {
